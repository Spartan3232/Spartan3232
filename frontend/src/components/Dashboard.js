...
import { MessageCircle, Target, TrendingUp, Users, Brain, Zap } from 'lucide-react';
      ...
      <main className="flex-1 lg:ml-64">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-blue-200">Grok • Gemini • Claude</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <StatCard
              title="AI Sohbetler"
              value={dashboardData?.recent_messages || 0}
              icon={MessageCircle}
              color="orange"
              change="+15%"
              changeType="positive"
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl shadow-strong p-6 animate-fade-in">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button className="px-4 py-2 bg-gradient-to-r from-blue-500 to-emerald-500 text-white rounded-lg hover:from-blue-600 hover:to-emerald-600 transition-all duration-300 btn-hover-lift">
                    Yeni Hedef
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  {dashboardData?.recent_goals?.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500 text-lg mb-4">Henüz hedef belirlenmemiş</p>
                      <button className="px-6 py-3 bg-gradient-to-r from-blue-500 to-emerald-500 text-white rounded-lg hover:from-blue-600 hover:to-emerald-600 transition-all duration-300 btn-hover-lift">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-strong p-6 animate-fade-in">
                ...
                <div className="space-y-3">
                  <button className="w-full flex items-center space-x-3 p-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-300 btn-hover-lift">
                    <MessageCircle className="w-5 h-5" />
                    <span>AI Koç ile Sohbet</span>
                  </button>
                  <button className="w-full flex items-center space-x-3 p-3 bg-gradient-to-r from-green-500 to-teal-500 text-white rounded-lg hover:from-green-600 hover:to-teal-600 transition-all duration-300 btn-hover-lift">
