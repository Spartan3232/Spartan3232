...
function build() {
  ...
  const mainScriptParts = [
    ...
    read('src/analytics/representative-analysis.js'),
    read('src/analytics/brick-analysis.js'),
    read('src/analytics/region-analysis.js'),
    read('src/analytics/customer-analysis.js'),
    read('src/analytics/forecast.js'),
    read('src/analytics/coaching.js'),
    read('src/pages/dashboard.js'),
    read('src/pages/decisions.js'),
    read('src/pages/representative360.js'),
    read('src/pages/brick360.js'),
    read('src/pages/customer360.js'),
    read('src/pages/products.js'),
    read('src/pages/plan.js'),
    read('src/pages/forecast.js'),
    read('src/pages/archive.js'),
    read('src/pages/quality.js'),
    read('src/pages/upload.js'),
    read('src/pages/reports.js'),
    read('src/app.js'),
    read('src/exports/csv.js'),
    read('src/exports/print.js'),
    read('src/exports/html-report.js'),
  ].join('\n');
