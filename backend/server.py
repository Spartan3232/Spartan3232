...
async def integrations_status():
    return {
        ...
        "sportsdata": bool(os.environ.get("SPORTSDATA_API_KEY")),  # optional, not required
...
async def fetch_api_basketball_games(league_name: str, date_iso: Optional[str] = None) -> List[Fixture]:
    # API-Sports Basketball for NBA, EuroLeague, BSL
...
async def list_fixtures(
    ...
    try:
        ...
        if sport == "basketball" and league:
            # Use API-Sports Basketball for all leagues including NBA
